...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'b7e6fee8796c35f54a5261bea0aeafb1'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '47b33c80f51d8a5b3bb60dd4258e13db'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_customers,read_orders'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://staging.project-progress.net/projects/laravelshopiapp/public/webhook/app-uninstalled')
        ], [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'ORDERS_CREATE'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://staging.project-progress.net/projects/laravelshopiapp/public/webhook/orders-create')
        ],
